...
[**Releases**](https://github.com/ATLAI-TECH/CapyBuddy/releases) page,
...
```bash
git clone https://github.com/ATLAI-TECH/CapyBuddy.git
cd CapyBuddy
...
从 [**Releases**](https://github.com/ATLAI-TECH/CapyBuddy/releases)
