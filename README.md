...
[**Releases**](https://github.com/ATLAI-TECH/CapyBuddyOfficial/releases) page,
...
```bash
git clone https://github.com/ATLAI-TECH/CapyBuddyOfficial.git
cd CapyBuddyOfficial
...
从 [**Releases**](https://github.com/ATLAI-TECH/CapyBuddyOfficial/releases)
